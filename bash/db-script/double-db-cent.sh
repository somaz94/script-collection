...
XLSX_FILE="${OUTPUT_PATH}/cent_rarity_specific_excloude_count_${DATE_STR}.xlsx"
...
WHERE status IN ('CENTRALIZED') AND owner <> '0x000000000000000000000000000000000000dead'
'''
