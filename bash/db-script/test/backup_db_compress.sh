...
do
    ...
    # Create a dump of the database with port specification
    mysqldump -h $DB_HOST -P $DB_PORT -u $DB_USER -p$DB_PASS $DB_NAME --set-gtid-purged=OFF > "$BACKUP_DIR/$BACKUP_FILE_NAME"
